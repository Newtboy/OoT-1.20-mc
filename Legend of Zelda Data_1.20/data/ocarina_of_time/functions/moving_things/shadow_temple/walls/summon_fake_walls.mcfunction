...
fill 1720 55 983 1736 55 983 minecraft:chain[axis=x]
...
summon minecraft:falling_block 1432 72 -763 {Tags:["FakeWall","FakeShadowWall"],BlockState:{Name:"polished_andesite"},Time:-999999999,NoGravity:1b}
